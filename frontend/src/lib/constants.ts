export const APP_NAME = "agent_eta";
export const APP_DESCRIPTION = "project eta";
...
export const WS_URL = process.env.NEXT_PUBLIC_WS_URL || "ws://localhost:8500";

// Backend API URL (public, for direct links like API docs)
export const BACKEND_URL = process.env.NEXT_PUBLIC_API_URL || "http://localhost:8500";
