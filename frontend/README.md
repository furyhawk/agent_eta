...
interface, auth, and dashboard for **agent_eta**.

## Prerequisites

- [Bun](https://bun.sh) (recommended) or Node.js 18+
- The backend running at `http://localhost:8500` (see the project root `README.md` — `make dev`)

## Getting Started

```bash
bun install        # install dependencies
bun dev            # start the dev server on http://localhost:3500
```
