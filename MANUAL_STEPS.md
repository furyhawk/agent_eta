# Manual setup steps for agent_eta
...
- [ ] Authorized redirect URIs: `http://localhost:3500/auth/callback`. Add prod URL when deploying.
...
- [ ] (Optional) Ingest seed documents: `uv run agent_eta rag-ingest /path/to/file.pdf --collection docs`.
