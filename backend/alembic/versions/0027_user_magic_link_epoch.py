...
Note: chains off ``0025`` (message thinking) — the former ``0026_create_mcp_connections``
migration was removed along with the MCP feature, so this revision now points
at the current head.
"""
