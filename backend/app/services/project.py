...
class ProjectService:
    ...
    async def update(self, project_id: UUID, data: ProjectUpdate, *, user_id: UUID) -> Project:
    ...
    async def add_member(
        ...
        *,
        ...
        existing = await project_repo.get_project_member(self.db, project_id, data.user_id)
        if existing:
    ...
    async def update_member(
        ...
        *,
        ...
        return await project_repo.update_member_role(self.db, db_member=member, role=data.role)
    ...
    async def remove_member(
        ...
        *,
        ...
        removed = await project_repo.remove_project_member(self.db, project_id, target_user_id)
        if not removed:
            raise NotFoundError(
                message="Member not found",
                details={"user_id": str(target_user_id)},
