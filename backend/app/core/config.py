...
class Settings(BaseSettings):
    ...
    LOGFIRE_SERVICE_NAME: str = "agent_eta"
    ...
    GOOGLE_REDIRECT_URI: str = "http://localhost:8500/api/v1/oauth/google/callback"
    ...
    S3_RAG_BUCKET: str = "agent_eta-rag"
