...
Reference for `agent_eta` runtime configuration. The
...
|---|---|---|---|
| `PROJECT_NAME` | optional | `agent_eta` | Used in logs, OpenAPI title, email templates |
...
| `BACKEND_URL` | optional | `http://localhost:8500` | Used by frontend BFF + email link generation |
| `FRONTEND_URL` | optional | `http://localhost:3500` | Used by password-reset / magic-link emails |
